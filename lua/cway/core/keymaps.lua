...
-- file explorer
keymap.set("n", "<leader>sf", ":Vexplore | :vertical resize 50<CR>", { desc = "Open file explorer" }) -- open file explorer

-- terminal
keymap.set("n", "<leader>st", ":vsp | terminal<CR> | i", { desc = "Open terminal" }) -- open terminal
keymap.set("t", "<leader>tn", "<C-\\><C-n>", { desc = "Exit i mode (terminal)" }) -- exit terminal
